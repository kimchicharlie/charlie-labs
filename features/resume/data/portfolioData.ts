...
export const portfolioData: PortfolioData = {
  personalInfo: {
    ...
    about: {
      en: "I've been building full-stack web apps since 2013, mostly at startups before joining Stingray. I've helped launch products, fix tricky issues, and keep systems running as they grew. I try to be a steady contributor and adapt to what the team needs.",
      fr: "Développeur full-stack depuis 2013, j'ai principalement travaillé dans des startups avant de rejoindre Stingray. J'ai participé au lancement de produits, résolu des problèmes techniques et assuré la stabilité des systèmes à mesure qu'ils évoluaient. Je m'efforce d'être un contributeur fiable et de m'adapter aux besoins de l'équipe.",
    },
  },
  contact: {
  ...
  experience: [
    {
      ...
      description: {
        en: [
          "Use performance-oriented web technologies (Lightning.js, Service Workers, AudioWorklet, WebAssembly, etc.) to run CPU-intensive applications on low-CPU smart TVs.",
